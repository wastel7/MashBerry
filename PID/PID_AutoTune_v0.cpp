...
int PID_ATune::Runtime(unsigned long now, double input, int *output)
{
	justevaled=false;
...
void PID_ATune::FinishUp(int *output)
{
	  *output = outputStart;
...
void PID_ATune::SetSetpoint(double Setpoint)
{
    setpoint = Setpoint;
}

double PID_ATune::GetSetpoint()
{
    return setpoint;
}
